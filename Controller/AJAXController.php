...
class AJAXController extends Controller
{
     ...
     *
     * @Route("/choices/users", name="bluemesa_user_ajax_choices")
     *
    ...
    public function userChoicesAction(Request $request)
    {
        ...
        $qb = $this->getDoctrine()
                   ->getManager()
                   ->getRepository('Bluemesa\Bundle\UserBundle\Entity\User')
     ...
     * Search for the specified entity by its property
     *
     * @Route("/choices/roles", name="bluemesa_role_ajax_choices")
     *
     * @param  \Symfony\Component\HttpFoundation\Request  $request
     * @return \Symfony\Component\HttpFoundation\Response
     */
